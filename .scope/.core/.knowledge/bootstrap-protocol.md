...
tags: ["protocol", "bootstrap", "pipeline", "project"]
---
...
3. Create scope internals:         .scope/pipelines/[name]/.knowledge/
                                   .scope/pipelines/[name]/.missions/definitions/
                                   .scope/pipelines/[name]/.missions/runs/
4. Create context index:        .brain/.knowledge.context_control/pipelines/[name].knowledge.catalog.yaml
...
3. Create scope internals:         .scope/projects/[name]/.knowledge/
                                   .scope/projects/[name]/.missions/definitions/
                                   .scope/projects/[name]/.missions/runs/
4. Create context index:        .brain/.knowledge.context_control/projects/[name].knowledge.catalog.yaml
...
3. Move .brain/.knowledge.context_control/[type]/[name].knowledge.catalog.yaml
                                                        → archive/.brain/[name].knowledge.catalog.yaml
4. Move .brain/.missions.context_control/[type]/[name].missions.catalog.yaml
