...
ENGINE_SCRIPT_MAP = {
    'engine': '.infra/engine.py',
    'scaler_engine': '.infra/engine.py',  # engine.py handles scaler when run in daemon mode
    'hustler_engine': '.infra/engine.py',
    'assets_engine': '.infra/engine.py',
    'ecoma_engine': '.infra/engine.py',
}

ENGINE_PID_FILES = {
    'engine': '.infra/pids/engine.pid',
    'scaler_engine': '.infra/pids/scaler_engine.pid',
    'hustler_engine': '.infra/pids/hustler_engine.pid',
    'assets_engine': '.infra/pids/assets_engine.pid',
    'ecoma_engine': '.infra/pids/ecoma_engine.pid',
}
