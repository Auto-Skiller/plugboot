...
credentials:
  ...
  when_to_use: "Use when designing UI components, establishing design systems, or auditing code for inclusive user experiences"
  triggers: ["accessibility", "a11y", "wcag", "inclusive", "aria"]
  role: "a11y-architect"
---
