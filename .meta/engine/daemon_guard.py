...
ENGINE_SCRIPT_MAP = {
    'meta_engine': '.meta/engine/engines/meta_engine.py',
    'pipeline_scaler_engine': '.meta/engine/engines/pipeline_scaler_engine.py',
    'pipeline_hustler_engine': '.meta/engine/engines/pipeline_hustler_engine.py',
    'projects_engine': '.meta/engine/engines/projects_engine.py',
    'dashboard_server': '.meta/engine/dashboard/backend/server.py',
}
...
ENGINE_PID_FILES = {
    ...
    'dashboard_server': '.meta/engine/pids/dashboard_server.pid',
}
...
def get_pid_file(engine_name: str) -> Path:
    ...
    relative = ENGINE_PID_FILES.get(engine_name, f'.meta/engine/pids/{engine_name}.pid')
