...
$remaining = Get-CimInstance Win32_Process -Filter "Name='python'" -ErrorAction SilentlyContinue |
    Where-Object {
        $_.CommandLine -and (
            $_.CommandLine.Contains('meta_engine') -or
            $_.CommandLine.Contains('pipeline_scaler_engine') -or
            $_.CommandLine.Contains('pipeline_hustler_engine') -or
            $_.CommandLine.Contains('projects_engine') -or
