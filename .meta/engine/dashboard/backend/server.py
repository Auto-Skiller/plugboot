...
class DashboardHandler(SimpleHTTPRequestHandler):
    ...
    def end_headers(self):
        ...
        # Prevent browsers from caching stale static assets (index.html, app.js, style.css).
        # The dashboard is under active development — every reload must fetch fresh files.
        # API responses (JSON) are inherently dynamic; this also keeps them fresh.
