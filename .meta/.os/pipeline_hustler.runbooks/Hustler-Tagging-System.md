...
credentials:
  description: Tag taxonomy ([new-data], [processed-data], [new-scraped], [new-def],
    [new-needs]) and Phase 3/4 processing playbook
  when_to_use: Read when transitioning data between pipeline stages or handling data
    gap provenance
  contains: tags, transitions, taxonomy
---
