...
credentials:
  description: Hard architectural laws and naming/structural rules that bind every
    agent.
  when_to_use: Consult before creating any new file, folder, session, or goal to ensure
    strict naming and architectural compliance.
  contains: rules, anti_patterns, behavioral_contracts
---
