<purpose>
Detect current project state and automatically advance to the next logical Open-workspace workflow step.
...
```
No Open-workspace project detected. Run `/gsd-new-project` to get started.
```
Exit.
</step>
