...
Spawned by the `/docs-update` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **workspace marker**: The comment `<!-- generated-by: doc-writer -->` — skip entirely.
