...
IDENTITY_DIR = os.path.join(WORKSPACE_ROOT, '_system', '.system-meta', '.system-os_prompts')
SYNC_ENGINE = os.path.join(INFRA_DIR, 'backend', 'engine.py')
...
def check_identity_laws():
    ...
    required_files = [
        '01_architecture-Operation_System.md',
        ...
        '02_behavior-Agents.md',
        '02_behavior-Permissions_and_Modes.md',
        '03_state_and_memory-Operations.md',
        '04_execution-Operations.md',
    ]
    if exists:
...
def check_db_files():
    db_files = [
        os.path.join(WORKSPACE_ROOT, '_system', 'system-board.yaml'),
        os.path.join(WORKSPACE_ROOT, '_system', 'system-index.yaml'),
    ]
    all_exist = True
    missing = []
    for f in db_files:
