...
3. Search `.core/mission_board/` — context and workflow definitions.
...
4. Document the blocker — in `CONTROLER.yaml` goal notes AND the specific mission run in `.core/mission_board/`.
