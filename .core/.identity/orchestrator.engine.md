...
The sync engines exist to prevent the AI agents from ever needing to guess paths. They manually scan `.core/` and the pipeline workspaces, and update the `.brain/meta.router/` maps automatically.
