...
const CATEGORIES: Category[] = [
    { id: '1', name: 'Operations', slug: 'operations', icon: Truck, color: 'text-red-400', articlesCount: 15 },
    { id: '2', name: 'Growth', slug: 'growth', icon: Zap, color: 'text-green-400', articlesCount: 12 },
    { id: '3', name: 'Command', slug: 'command', icon: Settings, color: 'text-purple-400', articlesCount: 10 },
    { id: '4', name: 'Admin & Team', slug: 'admin', icon: Users, color: 'text-slate-400', articlesCount: 8 },
];
