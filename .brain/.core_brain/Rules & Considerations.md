...
- **Strict Registry Maintenance**: Never create, rename, or move a file/folder within `.library/`, `.brain/`, or root resources without immediately ensuring the registry and maps are updated.
