...
> [!NOTE]
> This folder (`.[entity]-toolboxes/`) contains custom toolboxes, skills, and subagents that apply ONLY to this bounded context.
> Global shared toolboxes live in `_shared/.shared-toolboxes/`.

## How to Create Local Toolboxes
1. Create a domain folder: `.[entity]-toolboxes/<domain_name>/`
