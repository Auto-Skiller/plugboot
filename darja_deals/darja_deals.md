# `darja_deals` — Project Overview

> [!NOTE]
> This is the entry point for `darja_deals`.
...
## 📜 Active Missions
Check `darja_deals-board.yaml` for a real-time status of active missions and progress.
