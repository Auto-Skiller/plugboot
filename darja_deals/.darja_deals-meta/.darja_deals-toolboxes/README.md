...
> [!NOTE]
> This folder (`.darja_deals-toolboxes/`) contains custom toolboxes, skills, and subagents that apply ONLY to this bounded context.
> Global shared toolboxes live in `_shared/.shared-toolboxes/`.

## How to Create Local Toolboxes
1. Create a domain folder: `.darja_deals-toolboxes/<domain_name>/`
